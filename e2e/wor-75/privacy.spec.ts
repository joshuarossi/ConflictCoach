...
test.describe("WOR-75: Privacy security E2E tests", () => {
  test.describe("AC1: Cross-party private message isolation", () => {
    test.fixme("private coaching page does not display other party's messages", async () => {
  ...
  test.describe("AC2: Admin cannot read private messages", () => {
    test.fixme("admin user cannot view private coaching content for any party", async () => {
  ...
  test.describe("AC3: Coach AI does not leak private content", () => {
    test.fixme("joint chat coach response contains no 8-token match from private messages", async () => {
  ...
  test.describe("AC4: partyStates privacy", () => {
    test.fixme("case detail view shows only phase-level info for the other party", async () => {
  ...
  test.describe("AC5: FORBIDDEN errors, not silent failures", () => {
    test.fixme("unauthorized access attempt shows an error, not empty content", async () => {
