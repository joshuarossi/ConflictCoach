 I reviewed the repo as an evaluation of generated output, not as a fix pass. I did run npm install because local node_modules was stale; no tracked files changed.
  ...
  Many Convex modules start with /* eslint-disable @typescript-eslint/no-explicit-any */, for example convex/privateCoaching.ts:1, convex/jointChat.ts:1, and convex/cases.ts:1. This defeats one of Convex + TS’s
